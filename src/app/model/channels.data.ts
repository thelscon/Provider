...
export class ChannelData {
    ...
    static readonly Classic_Music: tChannel<'digital'> = {
        name: 'Classic Music',
        broadcastFormat: {
            digital: true
        }
    ...
    static readonly Hollywood: tChannel<'digital'> = {
        name: 'Hollywood',
        broadcastFormat: {
            digital: true
        }
    ...
    static get channels () : iChannel [] {
        ...
        let observableArray : iChannel [] = [] , 
            returnAray : iChannel [] = [] ;

        for ( let obj of Object.values ( this ) ) {
            observableArray.push ( obj ) ;  
        }

        from ( [ observableArray ] ).subscribe ( data => {
            returnAray = data
        } ) ;
...
// Object.defineProperty ( ChannelData , '' , {
//     enumerable : false
// } ) ;